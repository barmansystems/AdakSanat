...
class SendMessage extends Notification
{
    ...
    private function send_firebase_notification($message, $url, $firebaseToken)
    {
        try {
            ...
            $ch = curl_init("https://fcm.googleapis.com/v1/projects/adaksanat-cafe5/messages:send");
                ...
                "message" => [
                    ...
                    "webpush" => [
                        "notification" => [
                            "title" => "",
                            "body" => $message,
                            "icon" => 'https://adaksanat.moshrefiholding.com/assets/images/img/adak-sanat-purple-sm.png'
                        ],
                    ]
                ]
            ];

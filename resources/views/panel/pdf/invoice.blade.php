            ...
            <table>
                <tr>
                    <td style="width: 700px">
                        <img src="{{ public_path('/assets/images/img/adak-sanat-purple.png') }}" style="width: 15rem;">
                    </td>
                    <td>
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div>
                                    <span>نام شخص حقیقی/حقوقی: شرکت آداک صنعت خورشید قشم</span>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <span>شماره اقتصادی: 14013527534</span>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <span>شماره ثبت/شماره ملی: 7744</span>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <span>شناسه ملی: 14013527534</span>
                                </div>
                                <div style="height: 2rem">&nbsp;</div>
                                <div>
                                    <span>نشانی:استان هرمزگان، شهرستان قشم، بخش مرکزی، شهر قشم، اسکله بهمن ، بلوار ولی عصر، کوچه بازاربین المللی ستاره، پلاک 0، پاساژ ستاره، زمرد 1، طبقه 1، واحد 2045</span>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

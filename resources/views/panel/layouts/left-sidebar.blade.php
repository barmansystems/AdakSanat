...
<div class="left-side-menu">
    ...
    <div class="logo-box">
        <a href="javascript:void(0)" class="logo logo-dark text-center">
            <span class="logo-sm">
                <img src="/assets/images/img/adak-sanat-white-sm.png" alt="" height="26">
                <!-- <span class="logo-lg-text-light">Minton</span> -->
            </span>
            <span class="logo-lg">
                <img src="/assets/images/img/adak-sanat-white.png" alt="" height="30">
                <!-- <span class="logo-lg-text-light">M</span> -->
            </span>
        </a>
        <a href="javascript:void(0)" class="logo logo-light text-center">
            <span class="logo-sm">
                <img src="/assets/images/img/adak-sanat-white-sm.png" alt="" height="60">
            </span>
            <span class="logo-lg">
                <img src="/assets/images/img/adak-sanat-white.png" alt="" height="60">
            </span>
        </a>
    </div>
                        ...
                        <div class="collapse {{ $active_side ? 'show' : '' }}" id="products">
                            <ul class="nav-second-level">
                                ...
                                @can('parso-products')
                                    ...
                                    <li class="{{ $active_item ? 'menuitem-active' : '' }}">
                                        <a href="{{ route('parso.index') }}" {{ $active_item ? 'active' : '' }}>
                                            محصولات آداک تجارت
                                         </a>
                                    </li>
                                @endcan

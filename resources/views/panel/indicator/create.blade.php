                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-2 col-xl-3 col-lg-3 col-md-3">
                                        ...
                                        <select name="header" class="form-control" id="header">
                                            <option value="info">سربرگ فارسی آداک صنعت (Info)</option>
                                            <option value="sale">سربرگ فارسی آداک صنعت (Sale)</option>
                                            <option value="english">سربرگ انگلیسی آداک صنعت</option>
                                        </select>
                                        @error('header')
                                        <div class="invalid-feedback text-danger d-block">{{ $message }}</div>
                                        @enderror
